...
int main() {
    ...
    MyTreeNode<char> *root = MyNodeA; // 设置根节点

    // 输出结果
    std::cout << "---NonRecursive method---" << std::endl;
    std::cout << "PreOrder  : ";
    PreorderTraversal_NR<char>::preOrderTraverseNR(root);
    std::cout << std::endl;
    std::cout << "InOrder   : ";
    InorderTraversal_NR<char>::inorderTraversalNR(root);
    std::cout << std::endl;
    std::cout << "PostOrder : ";
    PostorderTraversal_NR<char>::postorderTraversalNR(root);
    std::cout << "\n--------------------------------------" << std::endl;
